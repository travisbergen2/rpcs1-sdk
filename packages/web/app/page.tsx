    ...
    <div className="bg-[#070b14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="max-w-3xl">
          ...
          <Link
            href="/translator"
            className="mt-7 inline-flex items-center text-sm font-semibold text-sky-400 underline-offset-4 hover:underline"
          >
            Try the Translator →
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-24 text-center sm:px-6">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/pricing#diagnostic"
            className="inline-flex items-center justify-center px-2 py-3.5 text-base font-semibold text-amber-300/90 underline-offset-4 transition-colors hover:text-amber-200 hover:underline"
          >
            Founding diagnostic — first 3 free →
          </Link>
        </div>
